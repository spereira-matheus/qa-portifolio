...
- API Testing & Validation (Playwright / Postman)
- Performance Testing (Apache JMeter)
- Risk-Based Testing & Critical Path Coverage
...
API testing suite built with Playwright Test `request` fixture, covering smoke tests, contract validation, and negative scenarios.

**Highlights:**
- API smoke tests used as CI quality gate
- Contract and schema-focused validations
- Negative and boundary scenarios
- Fully automated and CI-ready

🔗 https://github.com/spereira-matheus/playwright-api-testing
...
### ▶ Test Case Design  
Well-structured test case examples focused on risk-based testing, boundary conditions, and critical business scenarios.

🔗 https://github.com/spereira-matheus/test-case-design

---

### ▶ Bug Reporting Examples  
High-quality bug reports demonstrating clear reproduction steps, severity assessment, root cause hints, and business impact analysis.

🔗 https://github.com/spereira-matheus/bug-reporting-examples
